...
@Component
public class PolarisExceptionInterceptor implements HandlerExceptionResolver {
    private Logger logger = LoggerFactory.getLogger(PolarisExceptionInterceptor.class);
